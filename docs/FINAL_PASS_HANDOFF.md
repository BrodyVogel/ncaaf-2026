...
2. **Staleness:** snapshots frozen ~2026-07-18. 52 teams carry an L-graded QB (open or
   ...
   Step 3 before wagering. Applied 2026-07-19 (owner-approved): NMSU LB Tory Gethers
   confirmed back (current roster + active X account; the in-portal note was 2026-01-21)
   — LB 38 L → 44 M (NMSU rank 128→127, band 6.72→6.54).
