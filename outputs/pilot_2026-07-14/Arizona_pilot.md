...
- grade-implied def +25.27 vs anchor def +21.32
- residual (off-minus-def, grades-vs-anchor): **-5.02**
- resid decomposition (diagnostic): level -5.23 (=-0.541x anchor margin - the calibrated fade) + shape +0.21 (roster signal)
