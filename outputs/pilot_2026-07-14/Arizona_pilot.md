...
FINAL: **+5.99** (rank 35/138 in hybrid field)  band ±6.00
...
- grade-implied off +29.91 vs anchor off +30.98
- grade-implied def +25.38 vs anchor def +21.32
- residual (off-minus-def, grades-vs-anchor): **-5.14**
...
## 4. Assembly
- anchor +9.15  class -1.68  k×resid -1.80 (k=0.35, cap ±6.0)  ST -0.16  → recentered (-0.48) → **+5.99**
