...
- grade-implied def +28.53 vs anchor def +25.31
- residual (off-minus-def, grades-vs-anchor): **-3.78**
- resid decomposition (diagnostic): level +0.06 (=-0.541x anchor margin - the calibrated fade) + shape -3.85 (roster signal)
