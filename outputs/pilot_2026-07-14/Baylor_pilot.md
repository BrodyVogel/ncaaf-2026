...
FINAL: **+1.41** (rank 56/138 in hybrid field)  band ±6.18
...
- grade-implied off +24.02 vs anchor off +32.30
- grade-implied def +26.02 vs anchor def +28.20
- residual (off-minus-def, grades-vs-anchor): **-6.10**
...
## 4. Assembly
- anchor +4.70  class -1.68  k×resid -2.13 (k=0.35, cap ±6.0)  ST +0.04  → recentered (-0.49) → **+1.41**
