...
FINAL: **-0.97** (rank 71/138 in hybrid field)  band ±6.72
...
- grade-implied off +25.54 vs anchor off +29.23
- grade-implied def +30.98 vs anchor def +31.47
- residual (off-minus-def, grades-vs-anchor): **-3.19**
...
## 4. Assembly
- anchor -2.04  class +1.68  k×resid -1.12 (k=0.35, cap ±6.0)  ST +0.04  → recentered (-0.47) → **-0.97**
