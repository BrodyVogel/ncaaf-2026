...
| Pick Six 2026 | **in folder, captured 2026-07-14** | P4 only (68 teams). [UPDATED] Game Grader turned out to be retrospective 2025 results; the 2026 *prediction* (overall rank of 68) is the anchor input instead — captured, ordinal, converted to points in the loader. Not a talent-prior source; never opened at research time. |
...
- Pick Six 2026 — **in folder, inventoried 2026-07-14**: 6 text-searchable PDFs (`Pick Six 2026 - {General, ACC, B10, B12, SEC, Notre Dame}.pdf`). 2026 prediction captured to `anchors`-equivalent repo file `data/anchors/PickSix_2026preseason_2026-07-14.csv` (overall rank of 68, 68/68 validated via `pipeline/parse_picksix.py`). NOTE: Game Grader tables = 2025 results (retrospective, image-embedded), not the projection. **Anchor/compute-phase only — never a research source (§4).**
